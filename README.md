...
# Installation
To run this project either compile for your machine architecture or build Docker image. GOARCH build env might need to be adjusted to your requirements at the time of writing this README, you'd need to edit the Dockerfile.
